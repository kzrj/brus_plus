...
class LumberRecordsServisesTest(TransactionTestCase):
    ...
    def test_create_for_common_sale_exact_calc(self):
        data_list = [
            ...
            {'lumber': self.doska25_18, 'quantity': 65, 'shop_price': 7000, 'selling_price': 7200,
        ...
        self.assertEqual(lr1.shop_price, 12000)
        self.assertEqual(lr1.shop_total_cash, lr1.shop_price*lr1.quantity*lr1.lumber.volume)
    ...
    def test_create_for_common_sale_round_calc(self):
        ...
        self.assertEqual(lr3.shop_price, 7000)
        self.assertEqual(lr3.shop_total_cash, lr3.shop_price*lr3.quantity*lr3.lumber.volume)
    ...
    def test_create_for_common_sale_china_calc(self):
        data_list = [
            ...
            {'lumber': self.china_brus2, 'quantity': 15, 'shop_price': 15000,
        ...
        self.assertEqual(lr1.shop_price, 15000)
        self.assertEqual(lr1.shop_total_cash,
         round(lr1.shop_price*lr1.quantity*lr1.lumber.china_volume, 1))
        self.assertEqual(lr1.selling_price, 15000)
        self.assertEqual(lr1.selling_total_cash, 19010)
        self.assertEqual(lr1.selling_total_cash, round(lr1.shop_total_cash))
    ...
    def test_create_for_common_sale_mixed_calc(self):
        ...
        self.assertEqual(lr2.shop_price, 15000)
        self.assertEqual(lr2.shop_total_cash,
         round(lr2.shop_price*lr2.quantity*lr2.lumber.china_volume, 1))
        self.assertEqual(lr2.selling_price, 15000)
        self.assertEqual(lr2.selling_total_cash, 19010)
        self.assertEqual(lr2.selling_total_cash, round(lr2.shop_total_cash))
