...
class SaleServisesTest(TransactionTestCase):
    def setUp(self):
        ...
        data_list2 = {
            'lumbers': [
                {'lumber': self.brus1, 'quantity': 13, 'shop_price': 12000, 'selling_price': 12500,
                    'selling_total_cash': 7500, 'calc_type': 'exact'},
                {'lumber': self.china_brus1, 'quantity': 5, 'shop_price': 15000,
                    'selling_price': 15000, 'selling_total_cash': 19010, 'calc_type': 'china'},
                {'lumber': self.doska25_18, 'quantity': 53, 'shop_price': 7000, 'selling_price': 7500,
                    'selling_total_cash': 15443, 'calc_type': 'round'},
            ],
            'loader': True,
            'seller': self.seller1,
