...
# from stock.models import Shift, Lumber, LumberRecord, Shop, Sale, ReSaw
...
#         self.manager1 = User.objects.get(username='manager1')
#         self.manager1.account.can_see_shop_resaws.add(self.shop)

#         self.manager2 = User.objects.get(username='manager2')
#         self.manager2.account.can_see_shop_resaws.add(self.shop2)
